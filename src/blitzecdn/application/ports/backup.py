...
from blitzecdn.domain.backup import BackupComponent
...
class ArchiveGateway(Protocol):
    ...
    :func:`blitzecdn.domain.backup.unsafe_member` has to be applied to the whole
    archive while nothing has been written, and an adapter that could only
