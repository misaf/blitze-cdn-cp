...
make ``sites`` depend on the capability that already depends on ``sites``, which
...
from blitzecdn.capabilities.sites.policy.cache import CachePolicy, CacheQueryStringMode
