...
value, because a deployment is the only thing that takes one. Inside this
package rather than a level up, where it would have to be named in the layering
test twice over — once as a domain file, once as a module other capabilities
may import.
"""
