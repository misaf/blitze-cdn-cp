...
#
# `bootstrap` there is not a subcommand — this script has none. `bash -c
# SCRIPT NAME ARG...` assigns NAME to $0, so the word is the script name the
# usage message prints, and dropping it would consume --admin-cidr as $0.
#
